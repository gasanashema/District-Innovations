                  ...
                  <form>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="lname" type="text" class="form-control" id="lname" value="{{ auth()->user()->lname}}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="fname" type="text" class="form-control" id="fname" value="{{ auth()->user()->fname}}">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-8 col-lg-9">
                          <input name="title" type="text" class="form-control" id="title" value="{{ auth()->user()->title}}">
                        </div>
                    </div>
